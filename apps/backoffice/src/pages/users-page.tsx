...
import { api, type AdminCourse, type AdminEnrollment, type AdminUser } from '../api';
import { useAuth } from '../auth';

const ENROLL_STATUS: Record<AdminEnrollment['status'], string> = {
  active: 'Ativa',
  completed: 'Concluída',
  cancelled: 'Cancelada',
};
...
/** Gerencia as matrículas de um usuário: lista, matricula e remove. */
